                ...
                <div className="tabs-wrapper">
                    ...
                    <div style={{ display: "flex", marginTop: '30px', fontSize: '20px' }}>
                            ...
                            <HeadlessTippy visible={visible} onClickOutside={() => setVisible(false)} interactive placement="bottom-end"
                                ...
                                <div>
                                    ...
                                    <input style={{
                                        ...
                                        onFocus={() => fetchUsers()} ref={searchRef}
                        ...
                        <div style={{ flex: 1 }}>
                                    ...
                                    managers.map((manager) => {
                                        return (
                                            <SelectedManger user={manager} key={manager._id}
                                                handleClick={() => handleRemoveUser(manager)}
                                            ></SelectedManger>
                                        )
                                    })
                                }
                            ...
                            {
                                managers.length > 0 && <CustomAlertDialog message='The selected users will be granted access to the history of room entries and will have the ability to approve or reject future guest entries.'
